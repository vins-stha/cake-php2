    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $usersTable->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $usersTable->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $usersTable->id], ['confirm' => __('Are you sure you want to delete # {0}?', $usersTable->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
